...
const ADDRESS_PATTERN = /\b(de donde (son|sos|es|eres)|donde queda|donde estan|donde se encuentran|donde los encuentro|ubicaci[oó]n|direcci[oó]n|cual es (?:su|el) domicilio|domicilio (?:del|de el|de la) local|en donde se encuentran|a donde esta su local|que zona son)\b/i;
